...
import backdrop
from backdrop.collector.ga.realtime import Collector, Realtime, _timestamp
...
class TestCollector(object):
    @patch("backdrop.collector.ga.realtime.DataSet")
    @patch.object(backdrop.collector.ga.realtime.Realtime, "_authenticate")
    @patch.object(backdrop.collector.ga.realtime.Realtime, "execute_ga_query")
    ...
    @patch("backdrop.collector.ga.realtime.DataSet")
    @patch("backdrop.collector.ga.realtime.Realtime")
